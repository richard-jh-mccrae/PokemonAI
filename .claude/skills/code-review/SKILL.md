...
1. Issue references in the commit messages (`#123`, `Closes #45`, GitLab `!67`, etc.) — fetch via the workflow in `docs/agents/issue-tracker.md`. When you report or discuss what you found, name it as **Issue #123** (or **PR #123**), never a bare `#123` — the commit-message syntax itself stays bare since that's GitHub's own required form.
