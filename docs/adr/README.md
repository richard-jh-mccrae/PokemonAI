...
| [0043](0043-escalation-search-is-a-budgeted-depth-2-tree-on-a-close-attack-tie.md) | Escalation Search is a budgeted depth-2 tree on a close attack tie | **Deprecated (2026-07-16**, 2-ply opponent-survival grill Decision 6 → ADR-0064); already off in every shipped agent; code removal gated on corpus re-check |
