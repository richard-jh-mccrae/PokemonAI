...
**Next free number: 0088.**  
*(The pointer here read `0086` while `0086` was already taken on disk. Issue #241's ADR scanned `docs/adr/` rather than trusting it — as this file's own instruction says to — and took **0087**. Caught before it collided, which is the first time in this log.)*
