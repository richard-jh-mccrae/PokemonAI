...
| [0081](0081-the-deploy-marginal-prices-a-bench-slot-and-what-fills-it.md) | The deploy marginal prices a bench slot and what fills it | Accepted (grilled 2026-07-29, `/grill-with-docs` on Issue #197 — eight locked decisions); build = a new Value-System phase, filed **blocked-by Issue #199** (two legs are Worth-denominated and cross the ADR-0078 scale boundary). The fourth per-seam value equation beside ADR-0069/0070/0073; extends ADR-0065's Needs assignment and consumes ADR-0071's Bench Harvest. Replaces nine of the ten bench rules; `keep-a-bench` is PROMOTED to a post-setup sound rung, not deleted. Closes Issue #197 as the grill record (its items 3-4 superseded, item 2 dissolved). Number claimed, not settled — renumbered 0079 -> 0081 on rebase (Issue #161 kept 0079, Issue #199 took 0080) |
| [0081](0081-the-deploy-marginal-prices-a-bench-slot-and-what-fills-it.md) | The deploy marginal prices a bench slot and what fills it | Accepted (grilled 2026-07-29, `/grill-with-docs` on Issue #197 — eight locked decisions); build = a new Value-System phase. **Amendment A (2026-07-29) RE-OPENS decision 4**: Issue #199 merged without deriving the Worth Damage Rate (ADR-0080 ruled it moot for deny), and `deploy_anchor_sweep.py` shows this seam cannot anchor it either — structurally, since a deploy is never exclusive with a damage-denominated option. Decisions 1-3 and 5-8 stand. The fourth per-seam value equation beside ADR-0069/0070/0073; extends ADR-0065's Needs assignment and consumes ADR-0071's Bench Harvest. Replaces nine of the ten bench rules; `keep-a-bench` is PROMOTED to a post-setup sound rung, not deleted. Closes Issue #197 as the grill record (its items 3-4 superseded, item 2 dissolved). Number claimed, not settled — renumbered 0079 -> 0081 on rebase (Issue #161 kept 0079, Issue #199 took 0080) |
| [0081](0081-the-deploy-marginal-prices-a-bench-slot-and-what-fills-it.md) | The deploy marginal prices a bench slot and what fills it | Accepted (grilled 2026-07-29, `/grill-with-docs` on Issue #197 — eight locked decisions); build = a new Value-System phase. Amendments A-C: Issue #199 merged without deriving the Worth Damage Rate (ADR-0080 ruled it moot for deny) and `deploy_anchor_sweep.py` showed this seam cannot anchor it either — structurally, a deploy is never exclusive with a damage-denominated option. Decision 4 was RE-RULED: the Worth legs are dimensionless RATIOS over the Needs assignment, scaled by a preservation-pinned band, so no `WORTH_DAMAGE_RATE` is referenced and the currency guard stands. **UNBLOCKED**; decisions 1-3 and 5-8 stand. The fourth per-seam value equation beside ADR-0069/0070/0073; extends ADR-0065's Needs assignment and consumes ADR-0071's Bench Harvest. Replaces nine of the ten bench rules; `keep-a-bench` is PROMOTED to a post-setup sound rung, not deleted. Closes Issue #197 as the grill record (its items 3-4 superseded, item 2 dissolved). Number claimed, not settled — renumbered 0079 -> 0081 on rebase (Issue #161 kept 0079, Issue #199 took 0080) |
| [0083](0083-the-deploy-marginal-prices-a-bench-slot-and-what-fills-it.md) | The deploy marginal prices a bench slot and what fills it | Accepted (grilled 2026-07-29, `/grill-with-docs` on Issue #197 — eight locked decisions); build = a new Value-System phase. Amendments A-C: Issue #199 merged without deriving the Worth Damage Rate (ADR-0080 ruled it moot for deny) and `deploy_anchor_sweep.py` showed this seam cannot anchor it either — structurally, a deploy is never exclusive with a damage-denominated option. Decision 4 was RE-RULED: the Worth legs are dimensionless RATIOS over the Needs assignment, scaled by a preservation-pinned band, so no `WORTH_DAMAGE_RATE` is referenced and the currency guard stands. **UNBLOCKED**; decisions 1-3 and 5-8 stand. The fourth per-seam value equation beside ADR-0069/0070/0073; extends ADR-0065's Needs assignment and consumes ADR-0071's Bench Harvest. Replaces nine of the ten bench rules; `keep-a-bench` is PROMOTED to a post-setup sound rung, not deleted. Closes Issue #197 as the grill record (its items 3-4 superseded, item 2 dissolved). Number claimed, not settled — renumbered 0079 -> 0081 on rebase (Issue #161 kept 0079, Issue #199 took 0080). **Decision 9 (2026-07-30)**: we never bench during Set Up — a rule read off the rulebook (optional placement; my first turn precedes the first legal attack in either seat; no Basic carries a damage Ability), which subsumes three pregame special cases. Amendment F was proposed and WITHDRAWN the same day. Both ADR-0072 gates PASS *(authored as 0079, renumbered 0079 -> 0081 -> 0083 across two rebases — Issue #161 kept 0079, Issue #199 took 0080, and Issue #203 / Issue #211 took 0081 / 0082 while this branch was open)* |
