# ADR-0079 — The Set-Up Active pick is one deck declaration, not a pile of derived rungs

**Status:** Accepted (grilled 2026-07-28, `/grill-with-docs` on Issue #161 — nine locked decisions).
Build: Issue #161. **Authored as 0075, renumbered 0075 → 0077 → 0078 → 0079 across three rebases
(2026-07-29)** — ADR-0075 (the KO oracle's typed Budget), ADR-0076 (the opponent-target slot family),
ADR-0077 (a ranked count consumer reads `expected`) and ADR-0078 (the three currency scales) each
