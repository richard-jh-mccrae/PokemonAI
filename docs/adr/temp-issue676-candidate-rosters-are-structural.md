...
through search and selection at the cost of a major contract migration and a legacy Valued Candidate adapter.
...
successors, no Sampled Mean, and valid algorithm accounting. Legacy candidate status is a documented projection.
