# ADR-0084 — The deploy marginal prices a bench slot and what fills it
...
took 0080. Cite the issue alongside the number ("ADR-0084, Issue #197") — the number is a rebase
