...
A `starter`-Role branch was a second signal until ADR-0077 retired that Role; it never changed an
...
### `open-the-declared-starter` · weight 40 · status: assumed *(ADR-0077, 2026-07-28)*
