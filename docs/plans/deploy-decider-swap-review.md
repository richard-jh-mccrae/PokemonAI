# Deploy decider swap — review & hand-off (Issue #197, ADR-0084)
...
Nine rules, all named in ADR-0084's Consequences:
...
- `_PATH_BENCH_EXTRA = 1` may be stale against ADR-0071 decision 6 (ADR-0084 decision 5's observation).
