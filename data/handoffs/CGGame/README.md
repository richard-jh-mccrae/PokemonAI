...
| M2 — chain interpreter + 50-union burn-down + CI gate | [03-m2-union-burndown.md](03-m2-union-burndown.md) | 🔶 ACTIVE — resume here |
| M3 — verification API + `CG_ENGINE=py` selection | [04-m3-verification-api.md](04-m3-verification-api.md) | ⬜ todo |
