...
| M4 — pool-wide fan-out + coverage ledger | [05-m4-pool-fanout.md](05-m4-pool-fanout.md) | 🟢 core done 2026-07-11 (all 8 items built) — burn-down batches 1-4 + the ability-tail batch (2026-07-12) done: **1238/1556 attacks live, 305 traces green (28616 frames), ops 92/92, match-replay 60/60 CLEAN (card 269 Electric Streamer — the first repeatable ability — was the whole gap), the kaggle-episode ladder built: 414 real episodes convert+replay via four god-free reveal-oracle channels, 19→123 fully green**; the attribution tally is the ranked queue (stadiums Full Metal Lab/Battle Cage, supporters Dawn/Brock's, special energies Telepath/Mist, tools Lucky Helmet, abilities Ogerpon 96/Kangaskhan 756) |
