...
terminal or refused option is admitted unconditionally at delta 0.0 (the always-expand contract), and
on `85046350|0|decision|32` all five options price exactly 0.0.
