...
#: The DEPLOY lane (ADR-0084, Issue #197) — every way a body reaches MY Bench, which the Deploy
...
def option_slot(option: dict, frame: dict | None = None) -> tuple | None:
    ...
    **Rung 2 is ADR-0084's (Issue #197) extension, and it is why the parameter exists.** A mid-game
