"""Deploy DECIDER sweep — the Decision Gate's input for the no-shadow swap (Issue #197, ADR-0081).
...
decider ranks (ADR-0081's `option_slot` extension). `correct` (the human label, where the frame has
...
#: The rungs the Deploy Marginal retires (ADR-0081). Forced to 0 in the NEW pilot so this probe
