...
The question ADR-0081 (Issue #197) decision 4 left open, and ADR-0080 (Issue #199) made urgent by
...
and ADR-0081 Amendment A. Both sides do price nonzero here (Riolu `win_condition_base` 20.0 against
...
commutativity that let ADR-0081 decision 6 rule out a set-level planner is what closes this seam as a
rate anchor.
...
def main() -> int:
  ...
  Consequence: ADR-0081 decision 4 is re-opened. See ADR-0081 Amendment A.""")
    return 0
