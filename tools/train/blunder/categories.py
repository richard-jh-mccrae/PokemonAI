...
CATEGORIES: tuple[str, ...] = (
    ...
    # machine-only (ADR-0053 WP3): the value labeler's disagreement kind. NEVER authored by a human,
    # so machine records stay filterable and off the `other` vocab-gap signal.
    "value_delta",
)
