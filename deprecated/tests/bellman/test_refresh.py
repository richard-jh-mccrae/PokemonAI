...
from deprecated.bellman.refresh_evaluator import RefreshEvaluator
from common.scouting.provider import CardStat, DictCardStatProvider
from deprecated.bellman.value import KNOWN_CARD_FLOOR, CardFacts, Potential, ValueRegistry
...
def test_family_fold_orders_are_written_in_code_not_hashing():
    ...
    from deprecated.bellman.refresh_evaluator import (
        HAND_SIZE_TACTICAL_FAMILIES,
        HELD_OPTION_FAMILIES,
    )
