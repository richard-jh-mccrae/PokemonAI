"""The Bellman damage oracle (ADR-0032).

`compute_active_damage` is where the quarantined value stack combines Attack effect Clauses with
PokemonCard Weakness/Resistance and defender-side prevention.
...
__all__ = ("bench_reach", "compute_active_damage", "wr_adjust")
