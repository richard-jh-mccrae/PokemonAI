"""Versioned deck-scoped admissibility shared by turn searches."""
...
def action_policy_for_agent(agent: str) -> str:
...
def admissible_actions(observation, actions, policy: str):
...
__all__ = (
    ...
    "SUPPORTED_ACTION_POLICIES", "admissible_actions",
    "action_policy_for_agent",
)
