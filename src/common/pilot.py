...
_BRIEF_THREAT_BOOST = 1.25 # Deny Relevance's Brief SHARPENER (ADR-0079 decision 2, Issue #199): a body
...
class Pilot(PlannerMixin, ObjectivesMixin, GustMixin, FetchMixin, ShuffleRefreshMixin, ToolMixin):
    ...
    def __init__(self, strategy, deck, *, general_strategy=None, overrides=None, stats=None,
        ...
        self.deny_relevance = deny_relevance            # ADR-0079 / Issue #199 COMPUTE-ONLY switch: emits
    ...
    def _relevance_terms(self, b, *, doomed: frozenset, area: str, bi: int, brief_ids=()) -> dict:
        ...
        (ADR-0079, Issue #199 grill; `common/deny_relevance.py` owns the scoring, this owns the plumbing).
        ...
        — nothing reads these yet, Issue #187 is the consumer (ADR-0079 decision 4).
        ...
        A matched Brief's ``threats`` MULTIPLY the derived rank, never source it (ADR-0079
