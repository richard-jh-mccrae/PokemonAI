...
PROFILE = {
    ...
    "deny_relevance": False,        # ADR-0079 / #199 (S3c), COMPUTE-ONLY, ships OFF: emits the
                                    # **Deny Relevance** read — *is this Energy doing important work
                                    # for the opponent's plan?* — on `_opponent_target_rows`. The
                                    # read that REPLACED deny's magnitude: #199's grill measured the
                                    ...
                                    # new fields — #187 is the consumer and recharters to build the
