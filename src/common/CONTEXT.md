...
remains `REFUSED` — this is a provenance route, not generic CARD modelling.  (Issues #463 and #464;
Issue #470 closed not planned.)
...
open ruling — `ADR-0069`, and the user ruling of 2026-07-19.
...
Consumed in three places that must not drift, so all read one helper: the develop rung sims ONE
