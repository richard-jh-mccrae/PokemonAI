...
DEFINITIONS = (
    ...
    *(ParameterDefinition(f"family.{family}_{mode}", "family_ranking",
    ...
    ParameterDefinition("search.refinement_width", "search_waves", 2.0, 0.0, 64.0,
                        "actions", False),
    ParameterDefinition("search.completed_candidate_target", "search_waves", 2.0, 2.0, 32.0,
                        "lines", False),
    ParameterDefinition("search.completed_candidate_time_share", "search_waves", 0.20, 0.0, 1.0,
                        "decision_clock_share", False),
    ParameterDefinition("search.protected_bundle_time_share", "search_waves", 0.50, 0.0, 1.0,
                        "decision_clock_share", False),
    ParameterDefinition("search.protected_bundle_exploration_share", "search_waves", 0.25,
                        0.0, 1.0, "decision_clock_share", False),
    ParameterDefinition("search.protected_bundle_count", "search_waves", 2.0, 1.0, 8.0,
                        "bundles", False),
    ParameterDefinition("search.challenger_time_share", "search_waves", 0.10, 0.0, 1.0,
                        "decision_clock_share", False),
    ParameterDefinition("search.challenger_count", "search_waves", 2.0, 0.0, 16.0,
                        "actions", False),
    ParameterDefinition("search.challenger_enabled", "search_waves", 1.0, 0.0, 1.0,
                        "boolean", False),
    ParameterDefinition("search.stability_checkpoints", "search_waves", 2.0, 2.0, 8.0,
                        "checkpoints", False),
    ParameterDefinition("search.stability_patience_share", "search_waves", 0.20, 0.0, 1.0,
                        "decision_clock_share", False),
    ParameterDefinition("search.stability_patience_min_seconds", "search_waves", 1.0, 0.0, 60.0,
                        "seconds", False),
    ParameterDefinition("search.stability_patience_max_seconds", "search_waves", 10.0, 0.0, 60.0,
                        "seconds", False),
