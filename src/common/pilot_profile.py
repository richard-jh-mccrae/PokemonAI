...
DEFINITIONS = (
    ...
    ParameterDefinition("family.near_tie_batch_size", "family_ranking", 1.0, 1.0, 64.0,
                        "actions", False),
    ParameterDefinition("family.attachment_widening", "family_ranking", 0.0, 0.0, 1.0,
                        "boolean", False, family="attachment"),
    ParameterDefinition("family.attachment_ordering", "family_ranking", 0.0, 0.0, 1.0,
                        "boolean", False, family="attachment"),
    ...
    ParameterDefinition("search.uncertainty_margin", "search_waves", 0.10, 0.0, 10.0,
                        "bellman_value"),
    ParameterDefinition("clock.remaining_600_seconds", "planning_clock", 30.0, 2.0, 90.0,
                        "seconds", False),
    ParameterDefinition("clock.remaining_200_seconds", "planning_clock", 15.0, 2.0, 90.0,
                        "seconds", False),
    ParameterDefinition("clock.remaining_140_seconds", "planning_clock", 10.0, 2.0, 90.0,
                        "seconds", False),
