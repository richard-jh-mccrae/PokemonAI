...
DEFINITIONS = (
    ...
    *(ParameterDefinition(f"family.{family}_{mode}", "family_ranking",
    ...
    ParameterDefinition("search.uncertainty_margin", "search_waves", 0.10, 0.0, 10.0,
                        "bellman_value"),
    ParameterDefinition("search.needs_before_commitment", "search_waves", 1.0, 0.0, 1.0,
                        "boolean", False),
    ParameterDefinition("search.reveal_information_min_need", "search_waves", 0.5, 0.0, 10.0,
                        "bellman_value"),
    ParameterDefinition("needs.heal_min_gain", "value_equations", 0.3, 0.0, 10.0,
                        "bellman_value"),
    ...
    ParameterDefinition("needs.shadow_enabled", "needs_beam", 1.0, 0.0, 1.0,
                        "boolean", False),
    ParameterDefinition("needs.focus_enabled", "needs_beam", 1.0, 0.0, 1.0,
                        "boolean", False),
    ...
    ParameterDefinition("needs.horizon", "needs_beam", 2.0, 0.0, 6.0,
                        "turns"),
    ParameterDefinition("needs.max_ms", "needs_beam", 25.0, 0.1, 100.0,
                        "milliseconds", False),
