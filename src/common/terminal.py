...
from .algebra import Actor, Chance, Choice, Deterministic, Refresh, RevealChoice, Terminal, Unknown
...
def terminal_effects_supported(state: DecisionState, action: LegalAction, *,
                               card_id, recipient_id, effects, stats) -> bool:
