...
WHITELIST: tuple[SoundRule, ...] = (
    ...
    SoundRule(
        ...
        reconciliation="Queued wholesale for the post-POC learning phases (Issues #146–#148). Not "
                       ...
                       "opponent-build WORTH exists, not when a role sheet does. The byte-identical "
                       "mirror at `pilot.py`'s refresh-rate block carries the same correction, made "
                       "in the same commit. A SECOND member joined 2026-08-02 (Issue #261 item 2f) "
