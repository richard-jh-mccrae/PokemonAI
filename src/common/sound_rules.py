...
WHITELIST: tuple[SoundRule, ...] = (
    SoundRule(
        ...
        reason="The positional caps SUM to 590 (readiness 300 + survival 50 + threat 100 + value 40 "
               ...
               "**OWED A RULING — Issue #330** (repointed 2026-08-03 off POC-T3, Issue #262, which "
               "closed `completed` 2026-08-02 with the ruling undelivered; this was the only "
               "outstanding structural-invariant debt in the whitelist and it was left unowned, "
               "which is the exact failure this entry's closing sentence guards against). "
               "Issue #330 rather than Issue #263: Issue #330 IS this entry's question — *does a "
               "banked prize outbid `survival`* — and it carries both the measurement (12 corpus "
               "frames, held out on `owner: \"#330\"`) and the two strict-xfail TARGET tests in "
               ...
               "entry by landing, whether or not the pair invariant then holds. "
