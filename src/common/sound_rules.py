...
WHITELIST: tuple[SoundRule, ...] = (
    ...
    SoundRule(
        ...
        reason="Structural search caps, not tuned strategy: they bound WHAT IS EXPLORED, never what "
               ...
               "per-decision median 23.9 ms, P95 0.35-0.38 s, max 1.41-1.43 s, so the max sits at "
               "~46% of the floor and the bound holds. The measurement CORRECTED the bound's form "
               "in one respect: the arithmetic is quoted at the P95 width and therefore bounds the "
               "P95 decision, not the max one — corpus-wide leaf evaluations are 3465 and the "
