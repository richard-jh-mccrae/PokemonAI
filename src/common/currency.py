...
#
# ADR-0081 (Issue #197) asked the same question of the DEPLOY seam, which ADR-0078 decision 3 had
...
# ── The DEPLOY band — a SEAM-SCOPED rate, honestly labelled (ADR-0081 amendment C, Issue #197) ────
#
...
#:
#: One bound the corpus supplies directly (ADR-0081 amendment D, frame `85709280|1|match|`): the
