...
def footprints_writing_unhomed() -> dict:
    ...
    **EMPTY since T1 (Issue #260), and that is the finding now.** At T0 it was not: `_EVOLVE` and
    `_RETREAT` both clear Special Conditions (`docs/rules.md` §4 and §8) with no home for
