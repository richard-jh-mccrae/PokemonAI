...
**The Set-Up ACTIVE pick is ONE rule reading ONE deck declaration (ADR-0077).** It used to be five
...
HYPOTHESES = [
    ...
    Hypothesis(
        ...
        rationale="At the pregame Set-Up Active pick, open with the highest-ranked body the deck "
                  ...
                  "replaced (ADR-0077). Card-name-free: the ids live in the deck's declaration, and "
