...
HYPOTHESES = [
    Hypothesis(
        ...
        rationale="Risk scales with prize POSITION (learnthetcg fundamentals): when I'm clearly AHEAD "
                  ...
                  "the disruption cluster's hand-size (`dont-shuffle-away-the-bigger-hand`, keyed on "
                  "hand-count) and matchup-favorability (`dont-gift-a-refresh-when-favored`, keyed on "
