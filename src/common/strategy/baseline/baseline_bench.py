"""BASELINE cluster: BENCH — the empty-Bench reflex (ADR-0025, narrowed by ADR-0083).

Once held six rules about *what* to bench and *when*. The Deploy Marginal (`common.deploy_value`,
ADR-0083) prices that question as a value equation instead, so `dont-bench-multiprize`,
...
`keep-a-bench` STAYS, and is the whole file: ADR-0083 decision 7 rules it a **sound rung**, not a
