...
# Full baseline roster, in authored order (energy / snipe / bench / promote / retreat /
# evolution / heal / opening / sequencing / disruption). Order runtime-irrelevant (Pilot
# sums the scores); kept stable for legibility. (Tool rules promoted to Tool DOCTRINE —
