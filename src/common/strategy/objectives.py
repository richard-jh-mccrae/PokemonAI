...
class ObjectivesMixin:
    ...
    def _bench_shortens_their_path(self, obs, select, option, stat, board) -> bool:
        ...
        DERIVED from :meth:`_bench_path_delta` since ADR-0081: the sign of the magnitude, so the two
    ...
    def _bench_path_delta(self, obs, select, option, stat, board) -> float:
        ...
        The Deploy Marginal's exposure leg (ADR-0081 decision 5). This magnitude was already being
