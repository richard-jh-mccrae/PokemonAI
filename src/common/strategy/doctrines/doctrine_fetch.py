...
HYPOTHESES = [
    ...
    Hypothesis(
        ...
        rationale="At an in-game bench-PLACEMENT grab (`_TO_BENCH`), take a startable Basic — the "
                  ...
                  "from the scope by ADR-0084 decision 9 — we never bench during Set Up, so a +12 that could only "
    ...
    # `dont-pre-bench-a-redundant-utility` (−15) stood here until ADR-0084. All three answered the
