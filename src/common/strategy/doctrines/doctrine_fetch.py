...
HYPOTHESES = [
    ...
    Hypothesis(
        ...
        rationale="Play a `recycle` Item (Night Stretcher) to refill a THIN Bench when the discard holds "
                  ...
                  "the agent attacked / refreshed instead). +22 sequences it into sequence-band-0 (development) ahead "
    ...
    Hypothesis(
        ...
        rationale="Turn-1 premature-wincon-tutor veto (85164605:f6). A wincon-ONLY tutor whose payoff "
                  ...
                  "`_finish_turn_last` sequence band 4 (behind the sequence-band-2 attach and End) so the attach wins — merely "
                  "sinking it below the attach is NOT enough, a free PLAY at score>0 stays in sequence band 0 and plays "
    ...
    Hypothesis(
        ...
        rationale="During SETUP, a bare narrow `search` Supporter (Team Rocket's Petrel — search your deck for "
                  ...
                  "from sequence band 1 (endorsed non-shuffle Supporter, sequenced AHEAD of everything) to sequence band 4 "
                  "(score ≤ 0), so a sequence-band-3 shuffle-refresh now out-sequences it and wins the mutually-"
