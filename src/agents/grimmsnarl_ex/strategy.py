...
ROLES = {
    ...
    # (Snorunt + Budew carried a `starter` Role until 2026-07-28; ADR-0079 retired it — it drove
    ...
    #  ADR-0079 amendment A: with the five old Set-Up-Active rungs deleted, NOTHING scores this deck's
