...
_attack_stats = build_attack_stats(_all_attacks, load_attack_overrides())   # ADR-0032: per-attack effect
                                                   # records — Cosmic Beam's ignore-flags + damageMin=0,
                                                   # Mega Brave / Accelerating Stab locks, Aura Jab recover
