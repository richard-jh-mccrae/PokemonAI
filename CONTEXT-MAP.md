...
- **Submission & Tracking → Strategy Writeup**: **Agent History** + **Performance Log** + **Dashboard** are the evidence base for the Strategy-category Writeup — see [ADR-0012](./docs/adr/0012-optimize-for-strategy-category.md).
