...
def _deploy_ability_relevance(hand):
    ...
    mega_lucario pilot. Real, not the `_tagged_pilot()` stub: since ADR-0084 the leg matches the need
...
def test_bench_the_supporter_tutor_when_supporterless_in_setup():
    ...
    `bench-the-supporter-tutor` (+25) is DELETED — ADR-0084 decision 3 makes the bench-drop Ability a
