...
from common.decision.action_policy import (
    ALL_LEGAL_ACTION_POLICY, MEGA_STARMIE_ACTION_POLICY,
    action_policy_for_agent, admissible_actions,
)
...
def test_action_policy_is_deck_scoped():
    assert action_policy_for_agent("mega_starmie") == MEGA_STARMIE_ACTION_POLICY
    assert action_policy_for_agent("dragapult_ex") == ALL_LEGAL_ACTION_POLICY
