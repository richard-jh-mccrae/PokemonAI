...
SYNTHETIC_SOURCE_NAME_SITES = {
    ...
    ("tests/strategy/test_state_model.py", 48, 121),
    ("tests/strategy/test_state_model.py", 52, 112),
    ("tests/strategy/test_state_model.py", 53, 677),
    ("tests/strategy/test_state_model.py", 55, 678),
    ("tests/strategy/test_state_model.py", 59, 676),
    ("tests/strategy/test_state_model.py", 62, 675),
    ("tests/strategy/test_state_model.py", 65, 216),
    ("tests/strategy/test_state_model.py", 68, 215),
    ("tests/strategy/test_state_model.py", 69, 217),
    ("tests/strategy/test_state_value.py", 130, 121),
    ("tests/strategy/test_state_value.py", 134, 112),
    ("tests/strategy/test_state_value.py", 136, 677),
    ("tests/strategy/test_state_value.py", 138, 678),
    ("tests/strategy/test_state_value.py", 143, 1031),
    ("tests/strategy/test_state_value.py", 147, 46),
    ("tests/strategy/test_state_value.py", 151, 345),
    ("tests/strategy/test_state_value.py", 155, 1008),
    ("tests/strategy/test_state_value.py", 160, 743),
    ("tests/strategy/test_state_value.py", 165, 163),
    ("tests/strategy/test_state_value.py", 177, 1030),
    ("tests/strategy/test_state_value.py", 180, 119),
    ("tests/strategy/test_state_value.py", 183, 120),
    ("tests/strategy/test_state_value.py", 195, 676),
    ("tests/strategy/test_state_value.py", 198, 675),
    ("tests/strategy/test_state_value.py", 201, 276),
    ("tests/strategy/test_state_value.py", 215, 1031),
