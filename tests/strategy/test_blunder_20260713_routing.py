...
def test_f4_declines_pre_benching_a_redundant_utility_basic():
    ...
    Carried by ADR-0083 decision 9 — we never bench during Set Up — rather than by a price. This
...
# `test_f4_without_the_setup_log_the_basic_is_still_benched` stood here until ADR-0083 decision 9. It
