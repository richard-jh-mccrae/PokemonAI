...
def test_keep_a_startable_hand_declines_to_mulligan_a_startable_opener():
    ...
    # (The `starter` Role was a second accepted signal here until ADR-0077 retired it. It never
...
def test_open_the_declared_starter_prefers_the_decks_ranked_opener_at_setup_active():
    # Re-pointed from the deleted `open-the-accelerator` (ADR-0077). Same requirement — the deck gets
