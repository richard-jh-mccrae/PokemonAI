...
def test_the_worth_leg_stays_absent_until_its_anchor_is_captured():
    ...
    than pending, and ADR-0084's seam-scoped `DEPLOY_BAND` below is explicitly NOT this constant."""
...
def test_the_deploy_band_is_present_pinned_and_labelled_as_a_preservation_choice():
    """ADR-0084 (Issue #197) amendment C — the honest half of the guard above.
