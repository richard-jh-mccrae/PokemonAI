...
ROLES = {
    ...
    # (the `starter` Role was retired by ADR-0077; the openers are STRATEGY.starter_priority below)
...
STRATEGY = Strategy(
    ...
    roles=ROLES,
    # The deck's ordered opening bodies (ADR-0077) — mirrors the shipped agent so this fixture keeps
